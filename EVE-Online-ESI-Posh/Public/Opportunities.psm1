...
#>
    Param(
            [string]
            $URI = "https://esi.evetech.net/v1/characters/{character_id}/opportunities/",
    ...
    #  Example URI
    #  https://esi.evetech.net/v1/characters/{character_id}/opportunities/
    $Method = "get"
...
Export-ModuleMember -Function get-EVEcharacters_character_id_opportunities
...
#>
    Param(
            [string]
            $URI = "https://esi.evetech.net/v1/opportunities/groups/",
            [Parameter(Mandatory=$false, HelpMessage="The server name you would like data from")]
            [ValidateSet("tranquility")]
            [string]
            $datasource = "tranquility",
    ...
    #  Example URI
    #  https://esi.evetech.net/v1/opportunities/groups/
    $Method = "get"
    $URI = $URI -replace "{","$" -replace "}",""
...
Export-ModuleMember -Function get-EVEopportunities_groups
...
#>
    ...
    #  Example URI
    #  https://esi.evetech.net/v1/opportunities/groups/{group_id}/
    $Method = "get"
    $URI = $URI -replace "{","$" -replace "}",""
...
Export-ModuleMember -Function get-EVEopportunities_groups_group_id
...
#>
    Param(
            [string]
            $URI = "https://esi.evetech.net/v1/opportunities/tasks/",
            [Parameter(Mandatory=$false, HelpMessage="The server name you would like data from")]
            [ValidateSet("tranquility")]
            [string]
            $datasource = "tranquility",
    ...
    #  Example URI
    #  https://esi.evetech.net/v1/opportunities/tasks/
    $Method = "get"
    $URI = $URI -replace "{","$" -replace "}",""
...
Export-ModuleMember -Function get-EVEopportunities_tasks
...
#>
    Param(
            [string]
            $URI = "https://esi.evetech.net/v1/opportunities/tasks/{task_id}/",
            [Parameter(Mandatory=$false, HelpMessage="The server name you would like data from")]
            [ValidateSet("tranquility")]
            [string]
            $datasource = "tranquility",
    ...
    #  Example URI
    #  https://esi.evetech.net/v1/opportunities/tasks/{task_id}/
    $Method = "get"
    $URI = $URI -replace "{","$" -replace "}",""
...
Export-ModuleMember -Function get-EVEopportunities_tasks_task_id
