...
#>
    Param(
            ...
            [string]
            $datasource = "tranquility",
            [Parameter(Mandatory=$true, HelpMessage="An EVE mail ID")]
            [int32]
            $mail_id,
            [Parameter(Mandatory=$false, HelpMessage="Access token to use if unable to set a header")]
            [string]
...
#>
    Param(
            ...
            [string]
            $If_None_Match,
            [Parameter(Mandatory=$false, HelpMessage="Fetch only mails that match one or more of the given labels")]
            [array]
            $labels,
            [Parameter(Mandatory=$false, HelpMessage="List only mail with an ID lower than the given ID, if present")]
            [int32]
            $last_mail_id,
            [Parameter(Mandatory=$false, HelpMessage="Access token to use if unable to set a header")]
            [string]
...
#>
    Param(
            ...
            [string]
            $datasource = "tranquility",
            [Parameter(Mandatory=$true, HelpMessage="The mail to send")]
            [object]
            $mail,
            [Parameter(Mandatory=$false, HelpMessage="Access token to use if unable to set a header")]
            [string]
...
#>
    Param(
            ...
            [string]
            $datasource = "tranquility",
            [Parameter(Mandatory=$true, HelpMessage="Label to create")]
            [object]
            $label,
            [Parameter(Mandatory=$false, HelpMessage="Access token to use if unable to set a header")]
            [string]
...
#>
    Param(
            ...
            [int32]
            $character_id,
            [Parameter(Mandatory=$true, HelpMessage="Data used to update the mail")]
            [object]
            $contents,
            [Parameter(Mandatory=$false, HelpMessage="The server name you would like data from")]
            [ValidateSet("tranquility")]
